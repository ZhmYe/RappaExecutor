...
class CommitSlotItem:
    def __init__(self, sign, slot, size, params: CommitSlotModelParams):
        ...
        # self.set_hash("{}_{}_{}".format(self.signer, self.slot, self.node_id)) # TODO @YZM 这里要改master的hash，应该是在分配任务的时候就给一个唯一标识

    def set_index(self, index):
        self.index = index

    def set_nodeSign(self, node_sign):
